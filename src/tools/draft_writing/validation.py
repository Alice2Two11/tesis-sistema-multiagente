...
def build_draft_reports(sections, outline_sections, evidence_map, policy):
    ...
    validation_ok = all_section_validations_ok and invalid_citation_count == 0 and not sections_without_valid_citations and not sections_with_low_citation_density and not sections_with_claim_support_errors and not sections_with_quantitative_support_errors and numeric_failures == 0 and global_length_valid and not sections_outside_word_range
