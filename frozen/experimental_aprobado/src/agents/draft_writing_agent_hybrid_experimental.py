...
from src.tools.draft_writing.retrieval import retrieve_section_evidence_hybrid_experimental
from src.tools.draft_writing.source_aware_budgets import assign_source_aware_section_budgets
from src.tools.draft_writing.quantitative_augmentation import augment_evidence_with_quantitative_chunks_greedy
...
class DraftWritingAgent:
    ...
    def execute(self,agent_input):
        ...
        try:
            ...
            policy['section_budgets'] = assign_source_aware_section_budgets(
                sections,
            ...
            for section in sections:
                ...
                evidence=augment_evidence_with_quantitative_chunks_greedy(
                    base_evidence,
                    bundle['chunks'],
                ...
                for generation_attempt in range(1,int(policy.get('max_section_revision_attempts',2))+2):
                    prompt=build_section_prompt(section,evidence,quantitative_context,previous,policy)
